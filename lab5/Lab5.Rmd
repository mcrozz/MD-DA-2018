...
В выборке присутствуют `r sum(is.na(data$gender))` пустых клеток в столбце пола, удалим их и приведём данное поле в читабельный вид.
...
## Вывод
Потеря веса незначительно зависит от пола.