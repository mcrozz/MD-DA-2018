...
## Вывод
Потеря веса незначительно зависит от пола (`r THSD$gender[which(colnames(THSD$gender) == 'p adj')]` < 0.95), также из-за несбалансированности выборки данный результат можно считать biased.